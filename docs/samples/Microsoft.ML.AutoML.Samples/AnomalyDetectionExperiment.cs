...
{
    public static class AnomalyDetectionExperiment
    {
        ...
        public static void Run()
        {
            ...
            Console.WriteLine($"Running AutoML anomaly detection experiment for {ExperimentTime} seconds...");
            ExperimentResult<AnomalyDetectionMetrics> experimentResult = mlContext.Auto()
                .CreateAnomalyDetectionExperiment(ExperimentTime)
            ...
            RunDetail<AnomalyDetectionMetrics> bestRun = experimentResult.BestRun;
            ...
            AnomalyDetectionMetrics testMetrics = mlContext.AnomalyDetection.Evaluate(testDataViewWithBestScore);
        ...
        private static void PrintMetrics(AnomalyDetectionMetrics metrics)
        {
            Console.WriteLine($"AreaUnderRocCurve: {metrics.AreaUnderRocCurve}");
            Console.WriteLine($"DetectionRateAtFalsePositiveCount: {metrics.DetectionRateAtFalsePositiveCount}");
        }
    }
}
